...
| **Minimax M2-1** | — | — | — | **14/30 wins**, 7 ties, 9 loss (avg 7.8 vs 7.6) |
| **Opus 4.5** | 93% | 75% | **+18%** | — |
...
| Difficulty | With Skill | Without Skill | Delta | A/B Quality |
| --- | --- | --- | --- | --- |
| Simple | — | — | — | **6/10 wins**, 2 ties, 2 loss (avg 7.8 vs 7.3) |
| Medium | — | — | — | **4/10 wins**, 3 ties, 3 loss (avg 7.7 vs 7.7) |
| Complex | — | — | — | **4/10 wins**, 2 ties, 4 loss (avg 7.9 vs 7.7) |
| **Total** | **—** | **—** | **—** | **14/30 wins**, 7 ties, 9 loss (avg 7.8 vs 7.6) |

> No binary benchmark run for Minimax M2-1 — A/B quality only (iteration-7 responses).
